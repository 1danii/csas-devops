...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={cn("bg-primary", labelClassName)}>
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border bg-primary px-2.5 py-1.5 text-xs",
          className,
        )}
      >
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value && (
                        <span className="text-slate-950 dark:text-slate-50 font-mono font-medium tabular-nums">
        ...
        {payload.map((item) => {
          ...
          return (
            <div
              key={item.value}
              className={cn(
                "[&>svg]:text-slate-500 dark:[&>svg]:text-slate-400 flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3",
              )}
            >
